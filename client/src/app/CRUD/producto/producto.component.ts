...
export class ProductoComponent implements OnInit {
    ...
    constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ProductoService, private modalService: NgbModal) {
    ...
    isValid(entidadPorEvaluar: Producto): boolean {
        return true;
    }
    ...
    crearEntidad(): Producto {
        const nuevoProducto = new Producto();
        nuevoProducto.id = 0;
        return nuevoProducto;
    }

    add(entidadNueva: Producto): void {
    ...
    update(entidadParaActualizar: Producto): void {
    ...
    delete(entidadParaBorrar: Producto): void {
