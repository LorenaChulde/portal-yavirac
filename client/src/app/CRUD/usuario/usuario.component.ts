...
export class UsuarioComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: UsuarioService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: Usuario): boolean {
      return true;
   }
   ...
   update(entidadParaActualizar: Usuario): void {
   ...
   delete(entidadParaBorrar: Usuario): void {
   ...
   onSelect(entidadActual: Usuario): void {
