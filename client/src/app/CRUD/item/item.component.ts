...
export class ItemComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: ItemService, private modalService: NgbModal) {
 ...
 getItemPagina(): void {
   ...
   isValid(entidadPorEvaluar: Item): boolean {
      return true;
   }
   ...
   update(entidadParaActualizar: Item): void {
   ...
   delete(entidadParaBorrar: Item): void {
