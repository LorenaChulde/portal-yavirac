...
export class LinkComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: LinkService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: Link): boolean {
      return true;
   }
   ...
   update(entidadParaActualizar: Link): void {
   ...
   delete(entidadParaBorrar: Link): void {
